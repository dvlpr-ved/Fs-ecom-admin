...
const getTableData = async () => {
  ...
  const response = await makeCustomRequest({
    url: `api/customerReviewsReport?page=${page.value}`,
    method: "GET",
    query: {
      ...filters.value,
    },
...
<template>
  ...
  <DataTable v-if="data" class="mt-3" ref="table" :value="data" dataKey="id" :rows="10">
    <template #header>
      ...
      >
        <h5 class="m-0">Top shared products</h5>
    ...
    <Column field="Type" header="Product Name" headerStyle="width:auto; min-width:10rem;">
      <template #body="slotProps">
    ...
    <Column field="Title" header="Shares" headerStyle="width:auto; min-width:10rem;">
      <template #body="slotProps">
        <span class="p-column-title">Created at</span>
        {{ slotProps.data.shares ? slotProps.data.shares : "0" }}
      </template>
    </Column>    
    <Column field="Type" header="Last Posted at" headerStyle="width:auto; min-width:10rem;">
      <template #body="slotProps">
        <span class="p-column-title">user name</span>
        {{ slotProps.data.posted_date ? slotProps.data.posted_date : '' }}
      </template>
    </Column>

    <Column field="Type" header="One star rating" headerStyle="width:auto; min-width:10rem;">
      <template #body="slotProps">
        <span class="p-column-title">phone</span>
        {{ slotProps.data.one_star ? slotProps.data.one_star : "0" }}
      </template>
    </Column>
    <Column field="Type" header="Two star rating" headerStyle="width:auto; min-width:10rem;">
      <template #body="slotProps">
        <span class="p-column-title">phone</span>
        {{ slotProps.data.two_star ? slotProps.data.two_star : "0" }}
      </template>
    </Column>
    <Column field="Type" header="Three star rating" headerStyle="width:auto; min-width:10rem;">
      <template #body="slotProps">
        <span class="p-column-title">phone</span>
        {{ slotProps.data.three_star ? slotProps.data.three_star : "0" }}
      </template>
    </Column>
    <Column field="Type" header="Four star rating" headerStyle="width:auto; min-width:10rem;">
      <template #body="slotProps">
        <span class="p-column-title">phone</span>
        {{ slotProps.data.four_star ? slotProps.data.four_star : "0" }}
      </template>
    </Column>
    <Column field="Type" header="Five star rating" headerStyle="width:auto; min-width:10rem;">
      <template #body="slotProps">
        <span class="p-column-title">phone</span>
        {{ slotProps.data.five_star ? slotProps.data.five_star : "0" }}
      </template>
    </Column>
    <template #footer>
