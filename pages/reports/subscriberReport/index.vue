...
const getTableData = async () => {
  ...
  const response = await makeCustomRequest({
    url: `api/subscriberReport?page=${page.value}`,
    method: "GET",
    query: {
      ...filters.value,
    },
...
<template>
  ...
  <DataTable v-if="data" class="mt-3" ref="table" :value="data" dataKey="id" :rows="10">
    ...
    <Column field="Type" header="Gender" headerStyle="width:auto; min-width:10rem;">
      <template #body="slotProps">
        <span class="p-column-title">user name</span>
        {{
    ...
    <Column field="Type" header="Phone" headerStyle="width:auto; min-width:10rem;">
      <template #body="slotProps">
    ...
    <Column field="Title" header="No of Orders" headerStyle="width:auto; min-width:10rem;">
      <template #body="slotProps">
        <span class="p-column-title">SKU stock</span>
        {{ slotProps.data.order_count }}
      </template>
    </Column>
    <Column field="Title" header="Joined at" headerStyle="width:auto; min-width:10rem;">
      <template #body="slotProps">
