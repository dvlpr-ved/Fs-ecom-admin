      ...
      <div class="card">
        ...
        >
          ...
          <div class="field">
            ...
            <InputText
              id="name"
              v-model.trim="makeEntry.address"
              required="true"
              autofocus
              :invalid="submitted && !makeEntry.address"
            />
          </div>
          <template #footer>
            <Button
        ...
        >
          ...
          <div class="field">
            ...
            <InputText
              id="name"
              v-model.trim="editEntry.address"
              required="true"
              autofocus
              :invalid="submittededit && !editEntry.address"
            />
          </div>
          <template #footer>
            <Button
...
const saveEntry = async () => {
  ...
  if (makeEntry.name != "") {
    ...
    if (res.success) {
      ...
      toast.add({
        severity: "success",
        summary: "Vendor added successfully",
        life: 3000,
      });
    } else {
...
const deleteEntrySingle = async () => {
  ...
  if (res.success) {
    ...
    toast.add({
      severity: "success",
      summary: "Vendor deleted successfully",
      life: 3000,
    });
  } else {
    toast.add({ severity: "error", summary: "Something went wrong", life: 3000 });
