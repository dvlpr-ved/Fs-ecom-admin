      ...
      <div class="card">
        ...
        >
          ...
          <div class="field">
            ...
            <InputText
              id="name"
              v-model.trim="makeEntry.email"
              required="true"
              autofocus
              :invalid="submitted && !makeEntry.email"
            />
            <small class="p-invalid" v-if="submitted && !makeEntry.email"
          ...
          <div class="field">
            ...
            <InputText
              id="name"
              v-model.trim="makeEntry.password"
              required="true"
              autofocus
              :invalid="submitted && !makeEntry.email"
            />
            <small class="p-invalid" v-if="submitted && !makeEntry.password"
        ...
        >
          ...
          <div class="field">
            ...
            <InputText
              id="name"
              v-model.trim="editEntry.email"
              required="true"
              autofocus
              :invalid="submitted && !editEntry.email"
            />
            <small class="p-invalid" v-if="submitted && !editEntry.email"
              >Username is required.</small
            >
          </div>
          <div class="field">
            ...
            <InputText
              id="name"
              v-model.trim="editEntry.password"
              required="true"
              autofocus
              :invalid="submitted && !editEntry.email"
            />
            <small class="p-invalid" v-if="submitted && !editEntry.password"
              >Password is required.</small
            >
          </div>
          <template #footer>
...
const saveEntry = async () => {
  ...
  if (
    ...
    const res = await makeCustomRequest({
      ...
      body: {
        name: makeEntry.name,
        email: makeEntry.email,
        password: makeEntry.password,
        role: makeEntry.role,
      },
    });
    if (res.res) {
