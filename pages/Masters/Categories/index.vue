    ...
    <div class="grid">
        <div class="col-12">
            <div class="card">
                ...
                <Dialog v-model:visible="createDialog" :style="{ width: '450px' }" header="Create category" :modal="true" class="p-fluid">
                    <div class="field">
                    ...
                    <div class="field">
                        ...
                        <Button icon="pi pi-upload" class="mt-2 ml-2" severity="success" rounded @click="createImageUploader = true"  />
                    </div>
                    <ImageUploader single="true" :visible="createImageUploader" v-model="makeEntry.image" @close="createImageUploader = false" ></ImageUploader>
                    <template #footer>
                ...
                <Dialog v-model:visible="editDialog" :style="{ width: '450px' }" header="Edit Category" :modal="true" class="p-fluid">
                    ...
                    <div class="field">
                        <label for="name">Image</label>
                        <Button icon="pi pi-upload" class="mt-2 ml-2" severity="success" rounded @click="editImageUploader = true"  />
                    </div>
                    <ImageUploader single="true" :visible="editImageUploader" v-model="editEntry.image" @close="editImageUploader = false" ></ImageUploader>
                    <template #footer>
...
const deleteEntrySingle =async () => {
    ...
    if(res.res){
        ...
        getTableData();
        toast.add({ severity: 'success', summary: 'Category deleted successfully', life: 3000 });
    }
    else{
        toast.add({ severity: 'error', summary: 'Something went wrong', life: 3000 });
    }
